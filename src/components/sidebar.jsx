        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/profile.jfif)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Sai Kiran Yedugani </a></h1>
              <span className="email"><i className="icon-mail"></i> yedugani.saikiran@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/sai-kiran-yedugani-5a3643140/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
